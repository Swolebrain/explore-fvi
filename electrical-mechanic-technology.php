...
<title>Electrical Mechanic | Vatterott College</title>
...
<div id="wrapper" class="innerpage"> 
  ...
  <div class="banner_wrapper banner_wrapperinner electrical">
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">
        <h2 class="tag1">Vatterott College - Electrical Mechanic Programs</h2>
   <h4>Degree Earned: </h4>
        <ul>
<li>Electrical Mechanic Technology – Associate of Occupational Studies</li>     	
<li>Electrical Mechanic – Diploma/Certificate</li></ul>
        
        <h4>Electrical Mechanic Schools:</h4>
    <ul>
    ...
    <h2>Electrical Classes at Vatterott College are Enrolling Now!</h2>
    <p>Electrician training is designed to prepare the graduate with the theory and working knowledge in electrical installation, maintenance and repair to enter the workforce as an entry-level electrician or maintenance electrician. Students learn about electrical theory, blueprints, motor control and maintenance, wiring methods, electrical controls, electrical calculations, lighting, alarm systems, circuits, high-voltage, PLCs, National Electrical Code and much more. Students receive industry experienced instruction and hands on electrician training.</p>
    <p>"Employment of electricians is projected to grow 20 percent from 2012 to 2022, faster than the average for all occupations. As homes and businesses require more wiring, electricians will be needed to install the necessary components. Electricians with the widest variety of skills should have the best job opportunities." - <strong>Bureau of Labor Statistics</strong></p>
