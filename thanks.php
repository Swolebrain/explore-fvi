 ...
 <?php include 'includes/form.php'; ?>
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">        <h2 class="tag1">Thank you for your interest in Florida Vocational Institute!</h2>
        <p class="">One of our admissions counselors will be contacting you soon to answer any questions you may have, discuss your career objectives, and help you take the next step toward reaching your goals.</p>
        <p class=""> We look forward to speaking with you soon!</p>
