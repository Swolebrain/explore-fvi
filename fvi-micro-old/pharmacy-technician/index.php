...
if (isset($_GET['view']) && $_GET['view'] === 'full') {
	...
	/* If no cookies are set, run the function and forward as appropriate */
		...
		mobile_device_detect(true,true,true,true,true,true,'http://'.$_SERVER["HTTP_HOST"].'/pharmacy-technician/mobile/',false);
...
<div id="phone">Call Us Now!
	...
	<div class="main">
		...
		<div class="page">
			...
			<div class="content">
				<h1>Welcome to Florida Vocational Institute!</h1><br>
				<h2>Pharmacy Technician Program in Miami</h2><br>
			  <p>Florida Vocational Institute offers affordable training in a variety of healthcare careers. We provide our students with a comprehensive, career-oriented education by our experienced faculty. With the training you receive from Florida Vocational Institute, you'll be qualified to apply for entry-level positions in the ever growing health care industry - we're committed to providing the very best training.</p><br>
			  <h2>Florida Vocational Institute offers the following professional
</h2>
			  <h2>program:</h2><br>
			  <ul>
			  	<li>Pharmacy Technician Diploma</li></ul><br>
			  		<p>The Pharmacy Technician program provides instruction in how to assist the pharmacist in the packing and distribution of medication. </p>
			  		<p><strong>Graduates can find employment in the following environments:</strong></p>
			  		<ul>
			  			<li>Hospitals (private and government)</li>
			  			<li>Nursing care facilities</li>
			  			<li>Private and chain drug stores</li>
			  			<li>Drug manufacturers</li>
			  			<li>Wholesale drug houses</li>
			  			<li>Health maintenance organizations</li>
			  			</ul><br>
			  			<p>Students will also study the professional and technical skills necessary for direct employment as a pharmacy technician. A diploma will be awarded upon successful completion of this program.</p>
			  			<p>This program prepares students for a position as a pharmacy technician. The course will provide students the basic health care skills students can use as pharmacy technicians.</p><br>
			  			<h2>Why Choose FVI's Pharamcy Tech Program</h2><br>
			  			<ul>
...
<?php
include_once('../includes/form_pharm_tech.php');
?>
