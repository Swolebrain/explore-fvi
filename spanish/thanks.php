...
<title>Thank you Florida Vocational Institute</title>
 ...
 <?php include 'includes/form.php'; ?>
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">        <h2 class="tag1"> Gracias por su interés en el Florida Vocational Institute! </h2>
        <p class=""> Uno de nuestros consejeros de admisiones se comunicará con usted pronto para responder a cualquier pregunta que pueda tener, discutir sus objetivos de la carrera, y le ayudará a dar el siguiente paso hacia el logro de sus metas.</p>
        <p class=""> Esperamos poder hablar con usted pronto! </p>
