          ...
          <div class="information_form">
            <form action="http://api.ynotlms.com/leads.redirect" target="_top" method="post" id="frm_post" onSubmit="return CheckForm(this); ">
              ...
              <span id="step1">
	              ...
	              <select  class="input_1" name="program_id" id="program_id" onclick="setloc()">
	               <option value="" selected="">Primero elija un programa</option>
                    ...
                    <option value="4897">Técnico de Farmacia</option>
                    <option value="2213">Asistente de Enfermería con el HHA</option>

                    <option value="2211">Asistente Médico</option>
                    <option value="2212">Técnico de Atención al Paciente</option>
	              </select>
	              ...
	              <div class="left">
	           		...
	           		<div  class="right">
	              		...
	              		<input type="text"   class="input"  name="zipcode" id="zipcode" >
	           		              	...
	           		              	<p style="font-size:12px; line-height:22px; text-align:justify;">Sabemos que estás emocionado de empezar a trabajar en tu nueva carrera.! 
Al hacer clic en el botón del formulario de la página, entiendo que Florida Vocational Institute puede llamarme o enviarme un texto sobre los servicios Educacionales que ofrece  al número de teléfono proporcionado, incluyendo un número de teléfono móvil, utilizando la tecnología automatizada. Mi informacion sólo será utilizada por Florida Vocational Institute.
</p>              </span>

	           		</span>
              <div class="left"> <span class="calltext">Llámenos o rellene el siguiente formulario.</span><br>
